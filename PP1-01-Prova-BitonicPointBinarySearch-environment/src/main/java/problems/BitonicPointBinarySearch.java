 ...
 * de forma crescente (sempre vem primeiro) e outra ordenada de forma
 * decrescente.
 * O ponto bitônico desse array é o maior valor que divide essas duas partições.
 * 
 * Por exemplo:
 * O ponto bitônico do array [7,12,16, 20, 7,4,2,1] é o 20, pois do início até
 * ele
 * tem-se os elementos em ordem crescente e apos ele tem-se os elementos em
 * ordem
 * decrescente.
 * 
 * Pode acontecer de uma das partições (crescente ou decrescente) não exista no
 * array
...
public interface BitonicPointBinarySearch<T extends Comparable<T>> {
     ...
     * @return o ponto bitônico do array. Caso o array não tenha elementos, retorna
     *         null
     */
